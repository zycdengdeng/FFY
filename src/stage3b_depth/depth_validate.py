...
def main():
    ...
    e.add_argument("--out", required=True); e.add_argument("--model", default="facebook/VGGT-Omega")
    e.add_argument("--ckpt", default=None, help="本地权重路径,如 checkpoints/vggt_omega_1b_512.pt(不给则自动从 HF 下载,gated 需 HF_TOKEN)")
